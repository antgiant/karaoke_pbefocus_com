...
// `@soundtouchjs/formant-correction-worklet@2.1.1`, the package's
// pre-bundled `./processor` export (`.dist/formant-correction-processor.js`)
// -- https://github.com/cutterbl/SoundTouchJS (packages/formant-correction-
// worklet). MPL-2.0, see ../LICENSE. Self-contained (bundles
// @soundtouchjs/core + its own LPC formant-analysis code, no runtime
// imports), registered via audioWorklet.addModule same as
// ../soundtouch-processor.js -- see playback-engine.js. Used only for the
// vocal stem's pitch-shift node (see FormantCorrectionNode.js's doc
// comment for why).
