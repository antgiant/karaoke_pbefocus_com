...
// `.dist/SoundTouchNode.js` -- https://github.com/cutterbl/SoundTouchJS
// (packages/audio-worklet). MPL-2.0, see ./LICENSE. The package's own
// `index.js` barrel also re-exports `processOffline` (pulls in more of
// `.dist/`), which this app has no use for, so playback-engine.js imports
// this file directly instead of vendoring that barrel.
/*
