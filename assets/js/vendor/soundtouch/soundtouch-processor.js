...
// the package's pre-bundled `./processor` export
// (`.dist/soundtouch-processor.js`) -- https://github.com/cutterbl/SoundTouchJS
// (packages/audio-worklet). MPL-2.0, see ./LICENSE. Self-contained (bundles
// @soundtouchjs/core, no runtime imports), registered via
// audioWorklet.addModule same as this app's own hand-written worklets --
// see playback-engine.js. Replaces the old hand-rolled granular
// pitch-shift-processor.js; SoundTouch's WSOLA algorithm sounds meaningfully
// better than that 2-grain implementation's "chorus-y/robotic" artifacting.
