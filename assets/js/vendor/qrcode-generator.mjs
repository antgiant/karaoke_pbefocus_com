//---------------------------------------------------------------------
//
// Vendored as-is (unmodified) from npm `qrcode-generator@2.0.4`,
// `dist/qrcode.mjs` -- https://github.com/kazuhikoarase/qrcode-generator
// Chosen for AI_TODO.md item 5's playlist-sharing QR code: dependency-free,
// single file, no build step (this app has none), MIT-licensed. See
// assets/js/qr.js for the small app-specific wrapper around this.
//
