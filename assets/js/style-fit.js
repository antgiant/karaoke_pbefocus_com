...
const CHURCH_FIT_INFO = {
  "great-match": { emoji: "😇", phrase: "Great match for singing in church" },
  nervous: { emoji: "😬", phrase: "A bit of a stretch for singing in church" },
  "very-uncomfortable": { emoji: "😱", phrase: "A big departure for singing in church" },
};
...
export function churchFitText(churchFit) {
  if (Array.isArray(churchFit)) return `${churchFitEmoji(churchFit)} Varies for singing in church`;
